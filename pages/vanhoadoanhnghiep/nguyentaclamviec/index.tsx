import ModalAdd from '@/components/dat/Modal/VHDN/nguyentaclamviec/ModalAdd';
import ModalDelete from '@/components/dat/Modal/VHDN/nguyentaclamviec/ModalDelete';
import ModalEdit from '@/components/dat/Modal/VHDN/nguyentaclamviec/ModalEdit';
            ...
            label: (
                ...
                >
                    <Image
                        ...
                        preview={false}
                    />
                    <p className={styles.menuOption__item__text}>Xóa nguyên tắc làm việc</p>
                </div>
            ),
        },
    ];
