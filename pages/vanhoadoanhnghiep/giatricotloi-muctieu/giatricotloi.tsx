import ModalAdd from '@/components/dat/Modal/VHDN/giatricotloi/ModalAdd';
import ModalDelete from '@/components/dat/Modal/VHDN/giatricotloi/ModalDelete';
import ModalEdit from '@/components/dat/Modal/VHDN/giatricotloi/ModalEdit';
            ...
            label: (
                ...
                >
                    <Image
                        ...
                        preview={false}
                    />
                    <p className={styles.menuOption__item__text}>Xóa giá trị cốt lõi</p>
                </div>
            ),
        },
    ];
        ...
        <>
                ...
                <div className={styles.content}>
                    ...
                    <div className={styles.contentBody}>
                        <div className={styles.contentBodyText}>
                            <p>Giá trị cốt lõi đặc biệt của doanh nghiệp</p>
                        </div>
            ...
            >
                ...
                <div className={styles.content}>
                    ...
                    <div className={styles.contentBody}>
                        <div className={styles.contentBodyText}>
                            <p>Mong muốn sâu kín của khách hàng Quyền sở hữu Phát minh và Đơn giản hóa Đúng, rất nhiều Tìm hiểu và tò mò Thuê và phát triển tốt nhất Nhấn mạnh vào các tiêu chuẩn cao nhất Suy nghĩ lớn Thiên vị cho hành động Tiết kiệm Kiếm được niềm tin Lặn sâu Có xương sống; Không đồng ý và cam kết Cung cấp kết quả</p>
                        </div>
                        <div className={styles.contentBodyImg}>
                            <Image
                                src='/img/c.png'
