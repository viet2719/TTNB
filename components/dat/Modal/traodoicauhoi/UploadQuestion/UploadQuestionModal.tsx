...
import styles from './UploadQuestion.module.scss'
...
export default function UploadQuestionModal({ open, onClose }: UploadQuestionModalProps) {
    ...
    return (
        <>
            <Modal
                ...
                onCancel={onClose}
                footer={null}
                className={`${styles.UploadQuestionModal} UploadQuestionModal `}
            >
